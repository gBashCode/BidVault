...
async function main() {
  ...
  console.log(`✅ Bid 1 created for ${vendor1.email}: commitment=${bid1.commitment.slice(0, 18)}...`);
  ...
  console.log(`✅ Bid 2 created for ${vendor2.email}: commitment=${bid2.commitment.slice(0, 18)}...`);
