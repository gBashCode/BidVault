...
export const Route = createFileRoute("/dashboard/kyc-reviews")({
  head: () => ({
    meta: [
      { title: "KYC reviews — SealedBid" },
      { name: "description", content: "Review and approve vendor Know Your Customer documentation for procurement eligibility." },
    ],
  }),
...
const reviews: KycReview[] = [
  ...
  },
  {
    ...
    riskScore: "High",
    expiresAt: "—",
    notes: "Director flagged on EU sanctions list (Council Regulation 269/2014). Escalated to legal.",
  },
  {
    id: "KYC-2026-0116",
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-[14px] text-muted-foreground">
                Vendor identity verification, sanctions screening and document validation.
                All reviews are logged immutably to the audit chain.
              </p>
            </div>
                  ...
                  <div className="flex items-center gap-4">
                    <div>
                      <div className="flex items-center gap-2">
                        ...
                        >
                          <span className={`h-1 w-1 rounded-full ${statusDot[review.status]}`} />
                          {review.status}
                        </span>
                      </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="grid grid-cols-2 gap-2 font-mono text-[11px]">
                      ...
                      <div className="rounded-md border border-border bg-surface px-3 py-2">
                        ...
                        <div className="mt-0.5 text-foreground">{review.documentCount} files</div>
                      </div>
                      <div className="rounded-md border border-border bg-surface px-3 py-2">
