...
export const Route = createFileRoute("/dashboard/invitations")({
  head: () => ({
    meta: [
      { title: "Invitations — SealedBid" },
      { name: "description", content: "Manage vendor invitations across active and upcoming tenders." },
    ],
  }),
          ...
          <div className="flex flex-wrap items-end justify-between gap-4">
            <div>
              ...
              <p className="mt-2 max-w-2xl text-[14px] text-muted-foreground">
                ...
                Vendors receive a cryptographically signed invitation link with eIDAS verification.
              </p>
            </div>
                ...
                {invitations.map((inv) => (
                  <tr key={inv.id} className="group hover:bg-surface/60">
                    ...
                    <td className="px-5 py-2.5">
                      ...
                      <div className="font-mono text-[10.5px] text-muted-foreground">{inv.reg}</div>
                    </td>
                    <td className="px-5 py-2.5">
                      <div className="text-foreground">{inv.tenderTitle}</div>
                      <div className="font-mono text-[10.5px] text-muted-foreground">{inv.tender}</div>
                    </td>
                    <td className="px-5 py-2.5 font-mono text-[11px] text-muted-foreground">
                      {inv.sentDate}
                    </td>
              ...
              {[
                ...
                <li key={tender} className="flex items-center justify-between">
                  <div>
                    ...
                    <div className="font-mono text-[10px] text-muted-foreground">{ratio} accepted</div>
                  </div>
                  <span className="tabular font-mono text-[12px] font-medium text-primary">{pct}</span>
                </li>
              ))}
            </ul>
          </div>
