...
export const Route = createFileRoute("/dashboard/custody-status")({
  head: () => ({
    meta: [
      { title: "Custody status — BidVault" },
      {
        name: "description",
        content:
          "HSM network status, Shamir key shard custody, TPM attestation and custody chain monitoring.",
      },
    ],
  }),
...
const hsmNodes: HsmNode[] = [
  {
    id: "HSM-ZU-01",
    location: "Zürich · Equinix ZH4",
    jurisdiction: "CH",
    status: "online",
    lastHeartbeat: "2026-05-22 11:34:52Z",
    shardId: "shard-α-7e10",
    tpmVersion: "TPM 2.0",
  ...
  },
  {
    ...
    jurisdiction: "CH",
    status: "online",
    lastHeartbeat: "2026-05-22 11:34:51Z",
    shardId: "shard-β-4c52",
    tpmVersion: "TPM 2.0",
    tpmAttestation: "verified",
    firmware: "v3.8.2",
    uptime: "142d 07h",
  ...
  {
    id: "HSM-ZU-03",
    location: "Zürich · Interxion ZUR1",
    jurisdiction: "CH",
    status: "online",
    lastHeartbeat: "2026-05-22 11:34:50Z",
    shardId: "shard-γ-8f77",
    tpmVersion: "TPM 2.0",
    tpmAttestation: "verified",
    firmware: "v3.8.2",
    uptime: "89d 14h",
  ...
  {
    id: "HSM-SG-01",
    location: "Singapore · Equinix SG3",
    jurisdiction: "SG",
    status: "online",
    lastHeartbeat: "2026-05-22 11:34:48Z",
    shardId: "shard-δ-9012",
    tpmVersion: "TPM 2.0",
    tpmAttestation: "verified",
    firmware: "v3.8.1",
    uptime: "204d 22h",
  },
  {
    ...
    jurisdiction: "SG",
    status: "online",
    lastHeartbeat: "2026-05-22 11:34:47Z",
    shardId: "shard-ε-b614",
    tpmVersion: "TPM 2.0",
    tpmAttestation: "verified",
    firmware: "v3.8.1",
    uptime: "204d 22h",
  ...
  {
    id: "HSM-SG-03",
    location: "Singapore · Digital Realty SIN10",
    jurisdiction: "SG",
    status: "maintenance",
    lastHeartbeat: "2026-05-22 09:12:03Z",
    shardId: "shard-ζ-c0a4",
    tpmVersion: "TPM 2.0",
    tpmAttestation: "pending",
    firmware: "v3.8.0 → v3.8.2",
    uptime: "0d 00h",
  },
  {
    id: "HSM-SG-04",
    location: "Singapore · Global Switch SG1",
    jurisdiction: "SG",
    status: "online",
    lastHeartbeat: "2026-05-22 11:34:46Z",
    shardId: "shard-η-f00d",
    tpmVersion: "TPM 2.0",
    tpmAttestation: "verified",
    firmware: "v3.8.1",
    uptime: "178d 11h",
            ...
            <div className="grid gap-px overflow-hidden rounded-xl border border-border bg-border md:grid-cols-5">
              {[
                { k: "HSM nodes", v: `${onlineCount} / 7`, sub: "online" },
                {
                  k: "Shamir threshold",
                  v: "5 of 7",
                  sub: `${onlineCount} available — ${onlineCount >= 5 ? "threshold met" : "BELOW THRESHOLD"}`,
                },
              ...
              <div className="relative">
                ...
                <div className="mt-3 flex flex-wrap items-center gap-3">
                  {hsmNodes.map((node) => (
                    ...
                    >
                      <span
                        className={`h-2 w-2 rounded-full ${nodeStatusDot(node.status)} ${node.status === "online" ? "animate-seal-pulse" : ""}`}
                      />
                      <div>
                ...
                <tbody className="divide-y divide-border">
                  {hsmNodes.map((node) => (
                    <tr key={node.id} className="group hover:bg-surface/60">
                      <td className="px-5 py-2.5 font-mono text-[11px] font-medium text-foreground">
                        {node.id}
                      </td>
                      ...
                      <td className="px-5 py-2.5">
                        <span
                          className={`inline-flex items-center gap-1 rounded-sm px-1.5 py-0.5 font-mono text-[10px] uppercase tracking-[0.18em] ${tpmBadge(node.tpmAttestation)}`}
                        >
                          {node.tpmAttestation}
                        </span>
                      </td>
                      <td className="px-5 py-2.5">
                        <span
                          className={`inline-flex items-center gap-1.5 rounded-sm px-2 py-0.5 font-mono text-[10px] uppercase tracking-[0.18em] ${nodeStatusBg(node.status)}`}
                        >
                          <span
                            className={`h-1.5 w-1.5 rounded-full ${nodeStatusDot(node.status)}`}
                          />
                          {node.status}
                        </span>
                      </td>
                ...
                <table className="w-full text-[12.5px]">
                  ...
                  <tbody className="divide-y divide-border">
                    {[
                      {
                        t: "2026-05-22 09:12Z",
                        k: "hsm.maintenance.start",
                        node: "HSM-SG-03",
                        detail: "Firmware upgrade v3.8.0 → v3.8.2",
                        hash: "0xab12…9e44",
                      },
                      {
                        t: "2026-05-22 08:00Z",
                        k: "tpm.attest.batch",
                        node: "all",
                        detail: "6 of 7 verified · 1 in maintenance",
                        hash: "0xce34…f1a0",
                      },
                      {
                        t: "2026-05-21 20:00Z",
                      ...
                      },
                      {
                        ...
                        k: "shard.verify",
                        node: "HSM-ZU-03",
                        detail: "Key shard integrity check passed",
                        hash: "0x7788…4a11",
                      },
                      {
                        t: "2026-05-19 08:00Z",
                      ...
                      },
                      {
                        ...
                        k: "key.ceremony",
                        node: "all",
                        detail: "Annual key ceremony — 7 shards distributed",
                        hash: "0x0001…ffff",
                      },
                    ].map((e, i) => (
