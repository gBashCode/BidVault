...
export const Route = createFileRoute("/dashboard/compliance")({
  head: () => ({
    meta: [
      { title: "Compliance monitor — BidVault" },
      {
        name: "description",
        content:
          "Regulatory compliance checks, EU directives, ISO standards, GDPR and conflict of interest status.",
      },
    ],
  }),
...
const euDirectiveItems: ComplianceItem[] = [
  {
    id: "EU-001",
    rule: "Art 22(1) — E-procurement mandate",
    description: "All communications and submissions via certified e-platform",
    status: "compliant",
    lastChecked: "2026-05-22 08:00Z",
    evidence: "BidVault cert #ESI-2024-4412",
  },
  {
    id: "EU-002",
    rule: "Art 40 — Technical specifications",
    description: "Non-discriminatory technical specs referencing EU/ISO standards",
    status: "compliant",
    lastChecked: "2026-05-21 14:30Z",
    evidence: "Spec review v2.3 approved",
  },
  {
    id: "EU-003",
    rule: "Art 42 — Labels & certifications",
    description: "Accepted equivalents for all required certifications",
    status: "warning",
    lastChecked: "2026-05-22 08:00Z",
    evidence: "2 of 14 vendors pending equiv. review",
  },
  {
    id: "EU-004",
    rule: "Art 56 — Evaluation criteria published",
    description: "Award criteria and weighting disclosed in tender notice",
    status: "compliant",
    lastChecked: "2026-05-20 10:00Z",
    evidence: "Published in TED 2026/S 078-123456",
  },
  {
    id: "EU-005",
    rule: "Art 67 — Best price-quality ratio",
    description: "MEAT criteria applied with documented methodology",
    status: "compliant",
    lastChecked: "2026-05-21 14:30Z",
    evidence: "Methodology doc v1.4",
  },
];
...
const isoItems: ComplianceItem[] = [
  {
    id: "ISO-001",
    rule: "ISO 19583-1:2023 — Metadata schema",
    description: "Structured metadata attached to every tender document",
    status: "compliant",
    lastChecked: "2026-05-22 08:00Z",
    evidence: "Auto-validated on upload",
  },
  {
    id: "ISO-002",
    rule: "ISO 27001:2022 — ISMS certification",
    description: "Information security management system certification",
    status: "compliant",
    lastChecked: "2026-04-01 00:00Z",
    evidence: "Cert #IS-742891 valid to 2027-03",
  },
  {
    id: "ISO-003",
    rule: "ISO 37001 — Anti-bribery controls",
    description: "Anti-bribery management system integration",
    status: "compliant",
    lastChecked: "2026-05-15 09:00Z",
    evidence: "Annual audit passed 2026-05-15",
  },
  {
    id: "ISO-004",
    rule: "ISO 20400 — Sustainable procurement",
    description: "Sustainability criteria integrated into evaluation",
    status: "warning",
    lastChecked: "2026-05-22 08:00Z",
    evidence: "Social value weighting under review",
  },
];
...
const gdprItems: ComplianceItem[] = [
  {
    id: "GDPR-001",
    rule: "Art 35 — DPIA on file",
    description: "Data Protection Impact Assessment for bid data processing",
    status: "compliant",
    lastChecked: "2026-02-11 00:00Z",
    evidence: "DPIA v3 · approved 2026-02-11",
  },
  {
    id: "GDPR-002",
    rule: "Art 28 — Processor agreements",
    description: "DPA signed with all sub-processors (HSM, cloud, backup)",
    status: "compliant",
    lastChecked: "2026-05-01 00:00Z",
    evidence: "7 / 7 DPAs current",
  },
  {
    id: "GDPR-003",
    rule: "Art 32 — Encryption at rest",
    description: "All bid envelopes encrypted AES-256-GCM at rest",
    status: "compliant",
    lastChecked: "2026-05-22 08:00Z",
    evidence: "Continuous enforcement",
  },
  {
    id: "GDPR-004",
    rule: "Art 17 — Erasure schedule",
    description: "Automated PII erasure 24 months post award decision",
    status: "compliant",
    lastChecked: "2026-05-20 10:00Z",
    evidence: "Policy v2.1 · next purge 2026-06-01",
  },
  {
    id: "GDPR-005",
    rule: "Art 33 — Breach notification plan",
    description: "72-hour breach notification procedure documented and tested",
    status: "action",
    lastChecked: "2026-05-22 08:00Z",
    evidence: "Tabletop drill overdue — due 2026-05-18",
  },
];
...
const coiItems: ComplianceItem[] = [
  {
    id: "COI-001",
    rule: "Evaluator declaration — Panel A",
    description: "5 evaluators submitted conflict of interest declarations",
    status: "compliant",
    lastChecked: "2026-05-21 14:30Z",
    evidence: "5 / 5 filed · 0 conflicts",
  },
  {
    id: "COI-002",
    rule: "Evaluator declaration — Panel B",
    description: "3 evaluators submitted conflict of interest declarations",
    status: "warning",
    lastChecked: "2026-05-22 08:00Z",
    evidence: "2 / 3 filed · 1 pending",
  },
  {
    id: "COI-003",
    rule: "Procurement officer declaration",
    description: "Lead officer annual COI declaration",
    status: "compliant",
    lastChecked: "2026-04-19 00:00Z",
    evidence: "Filed by m.vlaeminck@fps-mob.be",
  },
  {
    id: "COI-004",
    rule: "Vendor relationship screening",
    description: "Automated screening of vendor-evaluator relationships",
    status: "compliant",
    lastChecked: "2026-05-22 08:00Z",
    evidence: "0 matches across 14 vendors",
  },
];
...
function CompliancePage() {
  ...
  const activeTender =
    tenders.find((t: any) => t.status === "OPEN" || t.status === "SEALED") || tenders[0];
              ...
              <div className="flex flex-wrap items-end justify-between gap-4">
                <div>
                  ...
                  <p className="mt-2 max-w-2xl text-[14px] text-muted-foreground">
                    Continuous regulatory compliance checks for tender{" "}
                    {activeTender ? activeTender.title : "GOV-2026-ROAD-INFRA-014"}. Status is
                    refreshed hourly from policy engine attestations.
                  </p>
                </div>
              ...
              <>
                ...
                <div className="grid gap-px overflow-hidden rounded-xl border border-border bg-border md:grid-cols-4">
                  ...
                  <div className="bg-card px-5 py-4">
                    ...
                    <div className="tabular mt-1 font-display text-2xl font-semibold text-success">
                      {compliantCount}
                    </div>
                    <div className="font-mono text-[10.5px] text-muted-foreground">
                      of {total} checks
                  ...
                  <div className="bg-card px-5 py-4">
                    ...
                    <div className="tabular mt-1 font-display text-2xl font-semibold text-amber-400">
                      {warningCount}
                    </div>
                    <div className="font-mono text-[10.5px] text-muted-foreground">
                      review recommended
                  ...
                  <div className="bg-card px-5 py-4">
                    ...
                    <div className="tabular mt-1 font-display text-2xl font-semibold text-red-400">
                      {actionCount}
                    </div>
                    <div className="font-mono text-[10.5px] text-muted-foreground">
                      immediate attention
                ...
                <div className="mt-8 space-y-6">
                  {sections.map((section) => {
                    const sectionCompliant = section.items.filter(
                        ...
                        {[
                          {
                            t: "2026-05-22 08:00Z",
                            k: "compliance.scan",
                            detail: "Hourly automated scan completed — 18 checks",
                            s: "compliant" as Status,
                          },
                          {
                            t: "2026-05-22 07:45Z",
                            k: "coi.filed",
                            detail: "Panel A evaluator #5 declaration received",
                            s: "compliant" as Status,
                          },
                          {
                            t: "2026-05-21 14:30Z",
                            k: "compliance.scan",
                            detail: "Hourly automated scan — 1 new warning",
                            s: "warning" as Status,
                          },
                          {
                            t: "2026-05-20 10:00Z",
                            k: "dpia.review",
                            detail: "DPIA v3 re-certified by DPO",
                            s: "compliant" as Status,
                          },
                          {
                            t: "2026-05-18 00:00Z",
                            k: "breach.drill.overdue",
                            detail: "Tabletop drill deadline passed",
                            s: "action" as Status,
                          },
                        ].map((e, i) => (
                          <tr key={i} className="hover:bg-surface/60">
                            ...
                            <td className="px-5 py-2.5 font-mono text-[11px] text-primary">
                              {e.k}
                            </td>
                            <td className="px-5 py-2.5">{e.detail}</td>
                            <td className="px-5 py-2.5">
                              <span
                                className={`inline-flex items-center gap-1.5 font-mono text-[11px] ${statusColor(e.s)}`}
                              >
