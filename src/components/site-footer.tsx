      ...
      <div className="mx-auto grid max-w-[1400px] gap-10 px-6 py-16 md:grid-cols-[1.4fr_1fr_1fr_1fr]">
        <div>
          <div className="flex items-center gap-2">
            ...
            <span className="font-display text-lg font-semibold">BidVault</span>
          </div>
          <p className="mt-4 max-w-sm text-sm text-muted-foreground">
            Cryptographic procurement infrastructure for enterprises and public institutions that
            require provable fairness.
          </p>
        ...
        {[
          {
            title: "Platform",
            links: ["Encrypted bids", "Reveal engine", "Audit ledger", "Vendor portal"],
          },
          {
            title: "Compliance",
            links: ["AES-256 / FIPS 140-3", "SOC 2 Type II", "ISO 27001", "GDPR · DPA"],
          },
      ...
      <div className="border-t border-border">
        <div className="mx-auto flex max-w-[1400px] flex-col items-start justify-between gap-2 px-6 py-5 text-xs text-muted-foreground md:flex-row md:items-center">
          <div className="font-mono uppercase tracking-[0.18em]">
            © 2026 BidVault Systems · Zurich / Singapore
          </div>
          <div className="font-mono uppercase tracking-[0.18em]">
